...
<div class="glass-card rounded-2xl p-6 max-w-3xl mx-auto">
    <h2 class="text-xl font-semibold mb-5">
        <i class="fas fa-plus-circle text-emerald-400 mr-2"></i> Form Proyek Baru
    </h2>
    ...
    <form action="{{ route('project.store') }}" method="POST">
        ...
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="number" name="anggaran_min" value="{{ old('anggaran_min') }}"
                       class="input-glass w-full" required>
            ...
            <div>
                ...
                <input type="number" name="anggaran_max" value="{{ old('anggaran_max') }}"
                       class="input-glass w-full" required>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="deskripsi" rows="4" class="input-glass w-full" required>{{ old('deskripsi') }}</textarea>
