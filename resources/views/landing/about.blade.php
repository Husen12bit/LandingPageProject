...
<div class="container mx-auto px-6">
    <div class="text-center mb-16" data-aos="fade-up">
        <h1 class="text-5xl font-extrabold bg-gradient-to-r from-purple-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">Engineering the Future of Work</h1>
    ...
    <div class="glass-card-premium p-8 rounded-2xl mb-20" data-aos="flip-left">
        <i class="fas fa-paintbrush-fine text-4xl text-emerald-400"></i>
    ...
    <!-- System Architecture dengan Teal accent -->
    <div class="mb-20" data-aos="zoom-in">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="glass-card-premium p-5 text-center border-t-4 border-teal-500">
                <i class="fas fa-cloud-upload-alt text-3xl text-teal-400"></i>
                <p class="font-mono text-sm mt-2">AWS GuardDuty + Detective</p>
            </div>
            <div class="glass-card-premium p-5 text-center border-t-4 border-emerald-500">
                <i class="fas fa-lock text-3xl text-emerald-400"></i>
    ...
    <div class="text-center mb-20" data-aos="fade-up">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            ...
            <span class="px-5 py-2 rounded-full glass-premium text-sm font-mono border border-teal-500/40 shadow-glow">{{ $tech }}</span>
            @endforeach
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-4 gap-6 mb-20">
        @php $team = [
            ['name'=>'Brayen Prasetyo', 'role'=>'Support & Documentation', 'icon'=>'🧠'],
            ['name'=>'Muhammad Abdullah Husaini', 'role'=>'Web Developer', 'icon'=>'🔒'],
            ['name'=>'Pius Hari Purba', 'role'=>'Principal Designer', 'icon'=>'🎨'],
            ['name'=>'Fito Rifqi Dwi Fatoni', 'role'=>'Mobile Developer', 'icon'=>'📱']
        ]; @endphp
