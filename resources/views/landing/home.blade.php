...
<div class="container mx-auto px-6 relative z-10">
    ...
    <div class="flex flex-col lg:flex-row items-center justify-between min-h-[85vh] gap-12 py-10">
        <div class="flex-1 text-center lg:text-left" data-aos="fade-up" data-aos-delay="100">
            <div class="inline-flex items-center gap-2 bg-teal-500/20 backdrop-blur-sm rounded-full px-4 py-1.5 border border-teal-400/30 mb-6">
                <span class="w-2 h-2 bg-teal-400 rounded-full animate-pulse"></span>
                <span class="text-xs font-medium tracking-wide text-teal-300">#1 Freelance Marketplace in Southeast Asia</span>
            </div>
            <h1 class="text-5xl md:text-7xl font-extrabold leading-tight tracking-tight">
                <span class="bg-gradient-to-r from-white via-purple-200 to-teal-200 bg-clip-text text-transparent">Unlock Top Talent,</span><br>
                <span class="bg-gradient-to-r from-purple-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">One Tap Away</span>
            </h1>
            ...
            <div class="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                ...
                <a href="#" class="magnetic-btn px-8 py-3.5 rounded-full btn-teal text-white font-semibold shadow-xl transition-all">
                    <i class="fab fa-google-play text-xl mr-2"></i> Google Play
                </a>
            </div>
            <!-- Trust badges with Teal & Emerald -->
            <div class="mt-10 flex flex-wrap gap-8 justify-center lg:justify-start text-sm">
                <div class="flex items-center gap-2"><i class="fas fa-shield-alt text-teal-400"></i> <span class="text-teal-300">100% Verifikasi</span></div>
                <div class="flex items-center gap-2"><i class="fas fa-lock text-emerald-400"></i> <span class="text-emerald-300">Escrow Aman</span></div>
                <div class="flex items-center gap-2"><i class="fas fa-headset text-purple-400"></i> <span>Support 24/7</span></div>
            </div>
            <div class="mt-8 flex gap-8 justify-center lg:justify-start" id="statCounter">
                <div><span class="stat-number text-2xl font-bold text-teal-400" data-target="25000">0</span><span class="text-sm text-gray-300">+ Freelancer</span></div>
                <div><span class="stat-number text-2xl font-bold text-emerald-400" data-target="8450">0</span><span class="text-sm text-gray-300">Proyek Selesai</span></div>
                <div><span class="stat-number text-2xl font-bold text-purple-400" data-target="98">0</span><span class="text-sm text-gray-300">% Kepuasan</span></div>
            </div>
        </div>
        <div class="flex-1 flex justify-center relative" data-aos="fade-left" data-aos-delay="200">
            <div class="relative w-64 h-[550px] rounded-[3rem] border-2 border-teal-500/40 shadow-2xl overflow-hidden bg-gradient-to-b from-purple-900/30 to-teal-900/30 backdrop-blur-sm float-3d">
                <div class="absolute inset-0 flex flex-col items-center justify-center gap-3">
                    <img src="{{ asset('images/app03.jpeg') }}" alt="Foto app">
                </div>
            </div>
            <div class="absolute -z-10 w-80 h-80 bg-teal-600/30 rounded-full blur-3xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
    </div>
    ...
    <div class="my-32 grid md:grid-cols-3 gap-6" data-aos="fade-up">
        <div class="glass-card-premium p-6 rounded-2xl hover-lift">
            <i class="fas fa-bolt text-3xl text-teal-400"></i>
    ...
    <div class="my-32" data-aos="zoom-in">
        <h2 class="text-4xl font-bold text-center mb-12 bg-gradient-to-r from-white to-teal-300 bg-clip-text text-transparent">Trusted by 8,000+ businesses</h2>
        <div class="relative max-w-4xl mx-auto overflow-hidden" id="testimonialCarousel">
            <div class="flex transition-transform duration-500 ease-out" id="carouselTrack">
                ...
                <div class="w-full flex-shrink-0 px-4">
                    <div class="glass-card-premium p-8 rounded-2xl text-center">
                        <div class="flex justify-center gap-1 text-teal-400 mb-3">{!! str_repeat('<i class="fas fa-star"></i>', $t['rating']) !!}</div>
                        <p class="text-gray-200 italic text-lg">“{{ $t['text'] }}”</p>
                        <div class="flex justify-center items-center gap-3 mt-6">
                            <div class="w-12 h-12 rounded-full bg-gradient-to-br from-teal-500 to-purple-400 flex items-center justify-center text-white font-bold">{{ $t['avatar'] }}</div>
                            <div class="text-left">
            ...
            <button id="prevTesti" class="absolute left-0 top-1/2 -translate-y-1/2 bg-black/50 p-2 rounded-full text-teal-400"><i class="fas fa-chevron-left"></i></button>
            <button id="nextTesti" class="absolute right-0 top-1/2 -translate-y-1/2 bg-black/50 p-2 rounded-full text-teal-400"><i class="fas fa-chevron-right"></i></button>
        </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto my-32" data-aos="fade-up">
        ...
        <div class="space-y-4" id="faqAccordion">
            @php $faqs = [
                ['q'=>'Bagaimana verifikasi freelancer?', 'a'=>'Setiap freelancer melalui pemeriksaan ID, portofolio, dan wawancara singkat dengan sistem verifikasi terenkripsi.'],
                ['q'=>'Apakah ada jaminan pembayaran?', 'a'=>'Ya, sistem escrow kami menggunakan smart contract yang melindungi dana Anda sampai proyek selesai.'],
                ['q'=>'Berapa fee platform?', 'a'=>'Hanya 5% dari nilai proyek, transparan tanpa biaya tersembunyi.'],
                ['q'=>'Dukungan teknis 24 jam?', 'a'=>'Tim support kami siap membantu via live chat dan email dengan SLA < 2 jam.'],
            ]; @endphp
            ...
            <div class="glass-card-premium rounded-xl overflow-hidden">
                <button class="faq-trigger w-full text-left p-5 flex justify-between items-center font-semibold text-white">
                    {{ $faq['q'] }}
                    <i class="fas fa-chevron-down transition-transform duration-300 text-teal-400"></i>
                </button>
                <div class="faq-answer max-h-0 overflow-hidden transition-all duration-500 px-5 text-gray-300 border-t border-teal-500/20">
    ...
    <!-- CTA Aurora Gradient (Purple-Teal-Emerald) -->
    <div class="aurora-bg rounded-3xl p-[2px] my-20" data-aos="flip-up">
        <div class="bg-slate-950/70 backdrop-blur-xl rounded-3xl p-10 text-center">
            ...
            <div class="flex justify-center gap-4 mt-8">
                ...
                <a href="#" class="magnetic-btn px-8 py-3 rounded-full bg-transparent border border-teal-400 text-teal-400 font-bold hover:bg-teal-500/20">Learn More</a>
            </div>
        </div>
    </div>
</div>
