...
<div class="container mx-auto px-6">
    <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
        <h1 class="text-5xl font-extrabold bg-gradient-to-r from-purple-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">Powerful Features, <br>Beautifully Crafted</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-min" data-aos="fade-up">
        <div class="glass-card-premium p-6 rounded-2xl md:col-span-2 row-span-2 hover-lift group">
            <i class="fas fa-search text-4xl text-teal-400 group-hover:scale-110 transition"></i>
        ...
        <div class="glass-card-premium p-6 rounded-2xl hover-lift">
            <i class="fas fa-chart-simple text-3xl text-emerald-400"></i>
        ...
        <div class="glass-card-premium p-6 rounded-2xl hover-lift">
            <i class="fas fa-star-of-life text-3xl text-purple-300"></i>
    ...
    <!-- Deep Dive: Visibility of System Status dengan Teal tracking -->
    <div class="my-32 grid md:grid-cols-2 gap-12 items-center" data-aos="fade-up">
        <div class="glass-card-premium p-8 rounded-2xl border-l-4 border-teal-500">
            <i class="fas fa-eye text-5xl text-teal-400 mb-4"></i>
            <h3 class="text-2xl font-bold">Visibility of System Status</h3>
            <p class="mt-4 text-gray-200 leading-relaxed">
                Setiap tahap proyek — dari “Proposal Diterima” hingga “Pengerjaan”, “Revisi”, dan “Selesai” — disertai umpan balik visual real-time, progress bar dengan warna <strong class="text-teal-400">Teal</strong>, dan notifikasi push. Prinsip <strong>Jakob Nielsen #1</strong> kami terapkan untuk transparansi penuh.
            </p>
            <div class="mt-6 flex items-center gap-3 text-sm">
                <span class="w-3 h-3 bg-teal-500 rounded-full animate-pulse"></span>
                <span class="text-teal-300">Live Tracking Active</span>
                <span class="ml-auto text-emerald-400"><i class="fas fa-check-circle"></i> Verified</span>
            </div>
        </div>
        <div class="relative flex justify-center">
            <div class="w-64 h-64 rounded-full bg-gradient-to-tr from-teal-700/40 to-purple-500/40 flex items-center justify-center backdrop-blur border border-teal-500/30">
                <i class="fas fa-diagram-project text-7xl text-teal-300"></i>
            </div>
        </div>
    </div>
</div>
